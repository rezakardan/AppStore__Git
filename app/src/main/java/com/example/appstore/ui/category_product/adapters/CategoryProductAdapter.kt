...
class CategoryProductAdapter @Inject constructor(@ApplicationContext private val context: Context) :
    RecyclerView.Adapter<CategoryProductAdapter.SearchViewHolder>() {


    lateinit var binding: ItemSearchBinding

    private var search = emptyList<ResponseProductCategory.SubCategory.Products.Data>()
    ...
    inner class SearchViewHolder(item: View) : RecyclerView.ViewHolder(item) {
        ...
        fun onBind(oneItem: ResponseProductCategory.SubCategory.Products.Data) {
    ...
    private fun initColorsAdapter(list:List<ResponseProductCategory.SubCategory.Products.Data.Color>){


        val colorAdapter=ColorsProductAdapter()
    ...
    fun setData(data: List<ResponseProductCategory.SubCategory.Products.Data>) {
    ...
    class DiffUtils(
        private val oldItem: List<ResponseProductCategory.SubCategory.Products.Data>,
        private val newItem: List<ResponseProductCategory.SubCategory.Products.Data>
    ) : DiffUtil.Callback() {
